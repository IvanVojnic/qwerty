...
// CreateAuthUser provides a mock function with given fields: _a0, _a1
func (_m *MockAuthorization) CreateAuthUser(_a0 context.Context, _a1 *models.UserAuth) error {
...
func (_m *MockAuthorization) GetUserByID(_a0 context.Context, _a1 uuid.UUID) (models.UserAuth, error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *MockAuthorization) SignInUser(_a0 context.Context, _a1 *models.UserAuth) error {
	ret := _m.Called(_a0, _a1)
...
func (_m *MockAuthorization) UpdateRefreshToken(_a0 context.Context, _a1 string, _a2 uuid.UUID) error {
